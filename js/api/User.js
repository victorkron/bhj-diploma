...
class User {
  ...
  static unsetCurrent() { //  Не поняла, как сделать так, чтобы значение удалялось не только в localStorage,
                          ...
                          // на приложенной картинке к объяснению реализации этого метода, пыталась решить вопрос
                          // с помощью ссылок и указателей (как в с++), но в js, как я поняла, такого нету...
